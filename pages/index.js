...
const App = () => {
  ...
  return (
    <div style={{ backgroundColor: '#2E8B57',   padding: '30px', borderRadius: '50px', boxShadow: '0 2px 4px rgba(0, 0, 0, 0.09)' }}>
    <h1>Birthday Invitation List</h1>
    <input type="text" value={name} onChange={(e) => setName(e.target.value)} />
    <button onClick={handleSetName}>Add Person</button><br /><br />
    <input type="text" value={deleteName} onChange={(e) => setDeleteName(e.target.value)} />
    <button onClick={handleDeleteName}>Remove</button><br /><br />
    <button onClick={handleGetNames}>View List</button>
    <button onClick={handleResetNames}>Remove All</button>
    <ul>
